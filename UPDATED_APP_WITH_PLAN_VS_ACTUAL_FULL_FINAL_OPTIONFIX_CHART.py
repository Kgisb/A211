...
# User sees MTD / Cohort. We FLIP the internal logic as requested:
    ...
    if not plan_df.empty and not actual_df.empty:
        ...
        try:
            ...
            opt_pairs = [
                ("First Calibration Count", "Planned First Cal Count", "Actual First Cal Count"),
                ("Calib Reschedule Count", "Planned Calib Resch Count", "Actual Calib Resch Count"),
                ("Calib Done Count", "Planned Calib Done Count", "Actual Calib Done Count"),
            ]
            for label, plan_col, act_col in opt_pairs:
